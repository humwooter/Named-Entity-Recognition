...
labels = [label for label in crf.classes_ if label != '8']
print(metrics.flat_classification_report(y_valid, y_val_pred, labels=labels))

# Print report for all labels
print(metrics.flat_classification_report(y_valid, y_val_pred))
